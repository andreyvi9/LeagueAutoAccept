...
namespace Leauge_Auto_Accept
{
    internal class Settings
    {
        ...
        public static bool shouldMsgbeOn = false;
        ...
        public static void toggleMessageSetting()
        {
            if (MainLogic.isMsgOn)
            {
                MainLogic.isMsgOn = false;
                shouldMsgbeOn = false;
            }
            else
            {
                MainLogic.isMsgOn = true;
                shouldMsgbeOn = true;
            }
            if (saveSettings)
            {
                ...
                foreach (var comma in commas)
                {
                    ...
                    switch (columns[0])
                    {
                        ...
                        case "autoAcceptOn":
                            ...
                            break;
                        case "autoMsgOn":
                            shouldMsgbeOn = Boolean.Parse(columns[1]);
                            break;
                        case "preloadData":
