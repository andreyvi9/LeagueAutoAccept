...
namespace Leauge_Auto_Accept
{
    internal class Updater
    {
        ...
        private static void versionCheck()
        {
            ...
            string[] latestRelease = webRequest("https://api.github.com/repos/andreyvi9/LeagueAutoAccept/releases/latest");
            ...
            else
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        Print.printCentered("github.com/andreyvi9/LeagueAutoAccept/releases/latest");
