    ...
    internal class UI
    {
        ...
        public static void mainScreen()
        {
            ...
            string[] optionValue = {
                ...
                MainLogic.isMsgOn ? "Enabled" : "Disabled"
        ...
        public static void toggleMessageSettingUI(int pos)
        {
            Print.printWhenPossible(MainLogic.isMsgOn ? ". Enabled" : " Disabled", topPad + pos, leftPad + 38);
        }
